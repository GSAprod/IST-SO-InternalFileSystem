...
int main() {
    ...
    //Link the previous target (now eliminated) to the symlink created (pointing to target)
    assert(tfs_sym_link(link_path1, target_path1) == -1);
